...
resultat = decrypt_message("Jm gbjtbju fodpsf ovju mpstrvf Mfb rvjuub mb nbjtpo Fmmf sftqjsb vo hsboe dpvq tfoubou 
bjs gsbjt ev nbujo Dibrvf qbt sftpoobju ebot mf tjmfodf ef mb svf eftfsuf Df kpvs bmmbju fusf efdjtjg fmmf mf tbwbju", "dict.txt")
print(f"Message déchiffré : {resultat[0]}")
print(f"Mapping initial : {resultat[1]}")
